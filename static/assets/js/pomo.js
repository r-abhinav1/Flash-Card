...
function changeTime() {
    if (study) {
        ...
        play_img.src = "/static/assets/img/pomo/play-button.jpg";
    }
    else {
        study = true;
        isPaused = false;
...
startButton.addEventListener('click', function () {
    if (!isPaused) {
        ...
        isPaused = true;
        play_img.src = "/static/assets/img/pomo/pause-button.jpg";
    }
...
function addTask() {
    ...
    if (newTask !== "") {
        ...
        img.id = "cross";
        // hr.id = "horizontal";
        img.src = "/static/assets/img/pomo/close-button.jpg";
        span.id = "li-content";
...
changeButton.addEventListener('click', function () {
    ...
    element.style.backgroundImage = `url(/static/assets/img/pomo/${newImageUrl})`;
});
